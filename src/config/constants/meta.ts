...
export const DEFAULT_META: PageMeta = {
  title: 'WagyuSwap',
  description:
    'The most popular AMM on BSC by user count! Earn WAGYU through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by WagyuSwap), NFTs, and more, on a platform you can trust.',
  image: 'https://wagyuswap.herokuapp.com/images/hero.png',
}
