...
const TotalPrizesCard = () => {
  ...
  const lotteryPrizeAmountBusd = new BigNumber(lotteryPrizeAmount).multipliedBy(wagyuPrice)
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              {wagyuPrice.gt(0) && <CardBusdValue value={lotteryPrizeAmountBusd.toNumber()} />}
            </PrizeCountWrapper>
          </Left>
          <Right>
