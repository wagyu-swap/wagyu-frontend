...
import { Heading, Button, Text } from '@wagyu-swap-libs/uikit'
  ...
  return (
    <>
      ...
      <Text color="textSubtle">
        {t('It looks like you’ve disabled your account by removing your Wagyu Collectible (NFT) profile picture.')}
      </Text>
      <Text>
