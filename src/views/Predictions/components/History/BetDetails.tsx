...
import { Flex, Text, Link, Heading } from '@wagyu-swap-libs/uikit'
  ...
  return (
    <StyledBetDetails>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="8px">
        ...
        <Link href={getVelasScanBlockNumberUrl(bet.round.lockBlock)} external>
          {bet.round.lockBlock}
        </Link>
      </Flex>
      <Flex alignItems="center" justifyContent="space-between">
        <Text>{t('Closing Block')}</Text>
        <Link href={getVelasScanBlockNumberUrl(bet.round.endBlock)} external>
          {bet.round.endBlock}
        </Link>
      </Flex>
    </StyledBetDetails>
