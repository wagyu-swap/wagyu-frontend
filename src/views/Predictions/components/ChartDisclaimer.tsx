...
import { ModalContainer, ModalBody, Text, Button, InjectedModalProps, LinkExternal, Flex } from '@wagyu-swap-libs/uikit'
    ...
    <ModalContainer title={t('Welcome!')} minWidth="320px">
      <ModalBody p="24px" maxWidth="400px">
        ...
        <Flex justifyContent="center" alignItems="center">
          <LinkExternal
            href="https://docs.wagyuswap.finance/products/prediction/prediction-faq#what-are-you-using-for-your-price-feed"
            external
          >
            {t('Learn More')}
          </LinkExternal>
