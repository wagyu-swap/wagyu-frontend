...
import { CardBody, Text, Flex, BlockIcon, LinkExternal } from '@wagyu-swap-libs/uikit'
      ...
      <CardBody p="16px">
        ...
        <RoundResultBox>
          <Flex flexDirection="column" alignItems="center">
            ...
            <LinkExternal href="https://docs.wagyuswap.finance/products/prediction" external>
              {t('Learn More')}
            </LinkExternal>
          </Flex>
        </RoundResultBox>
